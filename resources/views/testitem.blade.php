      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="logo" href="#"><img src="tempcss/images/logo.png"></a>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <button type="button" class="btn btn-primary" >aaaaa</button>
               </div>
            </div>
            ...
            <div class="row">
                <div class="galeryy"> 
                    <div class="ccontent">
					    <img  class=" img33"  src="">
                        <h3 class="hh33">watch</h3>
                        <p class="p33">lorem azezaezaejbazejbzejzae</p>
                        <h6 class="hh66">5555</h6>
                        <button class="buy1">buenow</button>
                    <div>  
                </div>  
